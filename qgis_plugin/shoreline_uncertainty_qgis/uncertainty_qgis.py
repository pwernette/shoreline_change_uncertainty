...
RMSE95 becomes the buffer radius used by epsilon_bands_qgis.py (the
"UNCERTAINTY" attribute in the original scripts).
"""
...
from .config_qgis import ShorelineYear, UncertaintyComponents
